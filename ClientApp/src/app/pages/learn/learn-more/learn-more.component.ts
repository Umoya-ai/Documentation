  ...
  public videoDataSource = [
    {
      ...
      <p>The first step is to log in to the ML Workbench with your credentials. We land into the home page of ML Workbench which has different sections like Data, Models, Code, Tasks, and Assets</p>
      ...
      <p>Before we could use this model for predictions, we need to load the model into ML Workbench’s memory</p>
      
      <p>To do that, we should first load the model into ML Workbenchs memory by clicking ‘Load into memory’</p>
    ...
    },
    {
      ...
      <p>Clicking the ‘Start’ button starts the model building process. One could monitor the progress in the ‘Tasks’ section of the ML Workbench</p>
      ...
      <p>In today's tutorial, let us predict via the ML Workbench. To do that, we should first load the model into ML Workbenchs memory by clicking ‘Load into memory’</p>
